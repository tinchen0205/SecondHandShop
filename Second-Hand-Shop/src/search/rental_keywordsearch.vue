            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div v-for="(result, index) in results" :key="index" class="col">
                <div class="card shadow-sm h-100">
                  <img :src="result.imgURL" class="bd-placeholder-img card-img-top mt-3" width="100%" height="225" alt="Product Image" @click="openRentalProductDetail(result.product_name)">
                  <div class="card-body">
